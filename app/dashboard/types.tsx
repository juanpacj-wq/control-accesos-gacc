...
export interface PersonaRegistro {
  id_persona?: string; // Agregado para mantener el ID de la persona
  Title?: string;
  Nombre: string;
  Apellidos: string;
  ...
  // Añadidos para la edición y visualización completa
  correo?: string;
  arl?: string;
  eps?: string;
  afp?: string;
...
// Documentos obligatorios para personas
export const DOCUMENTOS_OBLIGATORIOS_PERSONA = ["ARL", "EPS", "AFP", "Documento de identidad"];

// Documentos obligatorios para vehículos
export const DOCUMENTOS_OBLIGATORIOS_VEHICULO = ["SOAT", "TARJETA DE PROPIEDAD", "Revisión técnico mecánica"];
