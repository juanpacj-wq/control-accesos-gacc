...
export default function VehiculoDocumentos({ 
  ...
  // API URL y token de autenticación (misma que personas)
  ...
  const handleSubirDocumento = async () => {
    ...
    try {
      ...
      // Log para debugging
      console.log("📤 Datos enviados para vehículo:", datos);
      ...
      if (response.ok) {
        ...
        throw new Error(responseData.mensaje || responseData.message || `Error HTTP ${response.status}: ${response.statusText}`);
      }
    } catch (error) {
      ...
      <div className="mt-3 space-y-3">
        ...
        <Alert className="bg-blue-50 border-blue-200 py-2">
          ...
          <AlertDescription className="text-blue-700 text-sm">
            Por favor suba los documentos requeridos para el vehículo (SOAT, RUNT, Tarjeta de propiedad, etc.)
          </AlertDescription>
        </Alert>
        
        {/* Mostrar ID del vehículo para depuración */}
        <div className="text-xs text-gray-500">ID interno del vehículo: {idVehiculo || 'No disponible'}</div>
          ...
          <div>
            ...
            <Select value={tipoDocumento} onValueChange={setTipoDocumento}>
              ...
              <SelectContent>
                ...
                <SelectItem value="TARJETA DE PROPIEDAD">TARJETA DE PROPIEDAD</SelectItem>
