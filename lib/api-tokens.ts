// lib/api-tokens.ts
/**
 * Archivo centralizado para manejar todos los tokens y URLs de API
 * Modificado para soportar uso tanto en cliente como servidor
 */

// Interfaz para los endpoints de API
interface ApiEndpoint {
  url: string;
  token: string;
}

// Función para determinar si estamos en el servidor
const isServer = typeof window === 'undefined';

// Objeto con todos los endpoints y sus tokens correspondientes
// En el servidor, usa las variables de entorno directamente
// En el cliente, usa las rutas de API locales
